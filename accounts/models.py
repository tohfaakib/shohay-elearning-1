...
class Account(AbstractBaseUser, PermissionsMixin):
    ...
    phone = models.CharField(_('phone'), max_length=20, default=None, blank=True, null=True)
    current_institute = models.CharField(_('Current Institute'), max_length=150, default=None, blank=True, null=True)
    preferred_higher_education = models.CharField(_('Preferred Higher Education'), max_length=150, default=None, blank=True, null=True)
